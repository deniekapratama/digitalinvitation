...
<section id="hero" class="d-flex flex-column justify-content-center">
  <div class="container" data-aos="zoom-in" data-aos-delay="100">
    <h1>Welcome,</h1>
    <p>Kenapa harus Digital Invitationss ? <span class="typed" data-typed-items="Undangan Online, Pilih Design Undangan, Buat Undangan, Undangan Aktif"></span></p>
...
<main id="main">
  ...
  <section id="about" class="services">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h2>Apa itu Digital Invitation ?</h2>
        <p>Website untuk membuat undangan pernikahan secara online, bisa membuat undangan sendiri dengan templates
          undangan yang sudah di sediakan.</p>
        <p>Solusi pernikahan lebih hemat, praktis, dan kekinian dengan e-invitation yang disebar otomatis untuk
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
          <div class="icon-box iconbox-blue">
            ...
            <h4><a href="">Undangan Digital yang Berkesan </a></h4>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
          <div class="icon-box iconbox-orange ">
            ...
            <h4><a href="">Lebih Dekat dengan Para Tamu </a></h4>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
          <div class="icon-box iconbox-pink">
            ...
            <h4><a href="">Membuat Undangan Sesukamu</a></h4>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
          <div class="icon-box iconbox-yellow">
            ...
            <h4><a href="">Buku Tamu Digital </a></h4>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
          <div class="icon-box iconbox-red">
            ...
            <h4><a href="">Desain Templates Banyak</a></h4>
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
          <div class="icon-box iconbox-teal">
            ...
            <h4><a href="">Kirim Undangan Otomatis </a></h4>
  ...
  <section id="facts" class="facts">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        ...
        <p>Digital Invitation menjunjung tinggi kepuasan pelanggan, melalui website yang responsive, user friendly,
          serta pelayanan yang fast respon </p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="count-box">
            ...
            <span data-toggle="counter-up">33232</span>
            <p>Pelanggan</p>
          </div>
        </div>
  ...
  <section id="portfolio" class="portfolio section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h2>Templates Undangan Online</h2>
          ...
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <div class="portfolio-links">
                ...
                <a href="<?= base_url('templates/templates_details') ?>" data-gall="portfolioDetailsGallery" data-vbtype="iframe" class="venobox" title="Portfolio Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <center><a target="_blank" href="<?= base_url('templates'); ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Primary link</a></center>
    </div>
